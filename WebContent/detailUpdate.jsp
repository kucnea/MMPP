...
<h3>회원게시판 글 수정</h3>
<hr>
<form name="frm1" method="post" action="detailUpdate.do">
 ...
 <table>
 	...
 	<tr><td class="td1">작성자</td>
 		<td><input type="text" name="name" value="${bean.userId}" size="70" class="input1" disabled></td>
 	</tr>
 	
 	<tr><td class="td1">회원 비밀번호</td>
 	...
 	<input type="button" value="목록" onclick="location.href='freeBoardData.do'">
